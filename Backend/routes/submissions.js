...
router.post("/:id/resolve", authMiddleware, roleMiddleware("ADMIN"), submissionController.resolveConflict);
router.post("/", authMiddleware, upload.array("files"), submissionController.createSubmission);
