...
CREATE TABLE CONFLICT_ESCALATION (
    escalation_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    submission_id NUMBER NOT NULL,
...
CHECK (status IN ('PENDING','CONSENSUS','CONFLICT','RESOLVED','LOCKED'));