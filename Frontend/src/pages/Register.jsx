      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .rg-toggle {
          ...
          color: #3a7a9c; letter-spacing: 1px; text-transform: uppercase;
        ...
        .rg-error {
          ...
          padding: 10px 14px;
          font-family: 'Space Mono', monospace;
          font-size: 11px; color: #ff6677; letter-spacing: 1px;
          margin-bottom: 16px;
        ...
        <div className="rg-card">
          {success ? (
            <div className="rg-success">
              ...
              <button className="rg-btn" style={{ marginTop: 8 }} onClick={() => setSuccess(false)}>
                Back to login →
              </button>
            </div>
          ) : (
            <>
              ...
              <div className="rg-field">
                ...
                <input
                  name="name" type="text" className="rg-input"
              ...
              <p className="rg-footer">
                Already have an account? <span onClick={() => navigate("/Login1")}>Login</span>
              </p>
            </>
          )}
